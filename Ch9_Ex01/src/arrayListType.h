...
public:
   ...
   void insertEnd(const elemType& insertItem);
    ...
    int recSeqSearchImp(const elemType& item) const;
    	   ...
    	   //Postcondition: If item is found, its location where
    	   //               in the array the item is found;
...
template <class elemType>
int arrayListType<elemType>::recSeqSearch(const elemType& item, int first, int last) const
{
	if (first <= last)
	{
		if (list[first] == item)
